...
import 'package:correlation_and_regression/Regression_answer_screen.dart';
import 'package:flutter/material.dart';

class Regression_screen_2 extends StatefulWidget {
  int n = 1;
  Regression_screen_2(this.n, {super.key});

  @override
  State<StatefulWidget> createState() => _Regression_screen_2(n);
}

class _Regression_screen_2 extends State<Regression_screen_2> {
  int n = 1;
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) {
          return Regression_answer_screen(n, x_Controller, y_Controller);
        },
