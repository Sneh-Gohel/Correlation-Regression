...
import 'package:correlation_and_regression/Correlation_screen_2.dart';
import 'package:flutter/material.dart';

class Correlation_screen_1 extends StatefulWidget {
  int operation;
  Correlation_screen_1(this.operation, {super.key});

  @override
  State<StatefulWidget> createState() => _Correlation_screen_1(operation);
}

class _Correlation_screen_1 extends State<Correlation_screen_1> {
  int operation;
  final n_Controller = TextEditingController();
  final n = FocusNode();

  _Correlation_screen_1(this.operation);
        ...
        Navigator.push(
          ...
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) {
              return Correlation_screen_2(number,operation);
            },
            transitionsBuilder:
